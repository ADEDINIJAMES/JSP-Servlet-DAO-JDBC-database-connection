...
<head>
    ...
    <title>Member Area :: Ruby - Jewelry Store e-Commerce </title>
                ...
                <div class="main-menu-wrap">
                    <nav id="mainmenu">
                        <ul>
                            ...
                            <li class="dropdown-show"><a href="#">Log IN/Register</a>
                                <ul class="mega-menu-wrap dropdown-nav">
                                    ...
                                    <li class="mega-menu-item"><li class=""><a href="user?index=true">My Account</a>My Account</a>
                                    <ul>
            ...
            <div class="col-12 text-center">
                <div class="page-title-content">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="user" class="active">Register Goods</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-7 m-auto">
                ...
                <div class="login-register-wrapper">
                    ...
                    <nav class="nav login-reg-tab-menu">
                        ...
                        <a class="active" data-toggle="tab" href="#register">Register</a>
                    </nav>
                    <!-- Login & Register tab Menu -->
                    ...
                    <div class="tab-content" id="login-reg-tabcontent">
                        ...
                        <%--                            </div>--%>
                        <%--                        </div>--%>
                    <div class="tab-pane fade show active" id="login" role="tabpanel">                            <div class="login-reg-form-wrap">
                        <form action="product?admin=product" method="post">
                            <div class="single-input-item">
                                <input type="text" name="product-name" placeholder="product name" required/>
                            </div>

                            <div class="single-input-item">
                                <input type="text" name="product-quantity" placeholder="QUANTITY" required/>
                            </div>


                                <div class="col-lg-6">
                                    <div class="single-input-item">
                                        <input type="text" name = "product-price" placeholder="PRICE" required/>
                                    </div>
                                </div>

                                <div class="col-lg-6">
                                    <div class="single-input-item">
                                        <select name="product-category" id="dog-names">
                                            <option value="necklace">Necklace</option>
                                            <option value="wristwatches">wristwatches</option>
                                            <option value="male_cloth">MALE CLOTHES</option>
                                            <option value="female_cloth">FEMALE CLOTHES</option>
                                        </select>                                    </div>
                                </div>

                                <div class="single-input-item">
                                    <input type="text" name="product-colour" placeholder=" Enter the product colour" required/>
                                </div>
                            ...
                            <div class="single-input-item">
                                <button type="submit" class="btn-login">Register PRODUCTS</button>
                            </div>
                        </form>
