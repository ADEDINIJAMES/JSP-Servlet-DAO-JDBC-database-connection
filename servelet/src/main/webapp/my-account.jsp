        ...
        <div class="row">
            ...
            <div class="col-3 col-lg-9 col-xl-8 m-auto">
                <div class="main-menu-wrap">
                    <nav id="mainmenu">
                        <ul>
                            <li class="dropdown-show"><a href="user">Home</a>
                            ...
                            <%--                                </ul>--%>
                            <%--                            </li>--%>
                            <li class="dropdown-show"><a href="user?logout=true">logout</a></li>
                            ...
                            <div class="tab-content" id="myaccountContent">
                                ...
                                <div class="tab-pane fade show active" id="dashboad" role="tabpanel">
                                    <div class="myaccount-content">
                                        ...
                                        <div class="welcome">
                                            <p>Hello, CUSTOMER <strong> CAN BUY / PAY FOR PRODUCTS HERE</strong>
                                            </p>
                                                    ...
                                                    <div class="myaccount-table table-responsive text-center">
                                                        <% PrintWriter out2 = response.getWriter();
                                                            ...
                                                            listOfProduct.forEach(product->{
                                                                ...
                                                                out2.println("<a href ='product?buy="+product.getId()+"'> Buy</a>")
                                                                ;
