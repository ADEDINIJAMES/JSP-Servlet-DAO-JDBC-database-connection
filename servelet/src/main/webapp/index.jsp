...
<head>
    ...
    <title>JamTech Enterprise</title>
...
<%--                                    <li><a href="index6.jsp">Home Layout 6</a></li>--%>
                            ...
                            <li class="dropdown-show"><a href="user">Log IN/Register</a>
                                <ul class="mega-menu-wrap dropdown-nav">
                                    ...
                                    <li class="mega-menu-item"><li class=""><a href="#">My Account</a>My Account</a>
                                        <ul>
...
<%--                                            <li><a href="single-product-external.jsp">Single Product External</a></li>--%>
                            ...
                            <li class=""><a href="user?admin=true">Admin</a>
...
<%--                            </li>--%>
                            <li class="dropdown-show"><a href="#">Blog</a>
                                <ul class="dropdown-nav">
                                    <li><a href="user">Blog Right Sidebar</a></li>
...
<%--                                    <li><a href="single-blog.jsp">Blog Details</a></li>--%>
                            ...
                            <li><a href="user">Contact Us</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
                        ...
                        <li class="shop-cart"><a href="#"><i class="fa fa-shopping-bag"></i> <span
                            ...
                            <div class="mini-cart">
                                ...
                                <div class="mini-cart-footer">
                                    <a href="#" class="btn-add-to-cart">Checkout</a>
                                </div>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="col-lg-6 m-auto">
                ...
                <div class="about-content-wrap ml-0 ml-lg-5 mt-5 mt-lg-0">
                    ...
                    <div class="about-text">
                        <p>We deliver quality wears , prompt to time at affordable rates. Our customers' comfortability remains our desire </p>

                        <p>Integrity, empathy and discipline are our topmost priorities</p>
                                ...
                                <div class="products-carousel owl-carousel">
                                    ...
                                    <div class="single-product-item text-center">
                                        ...
                                        <div class="product-meta">
                                            ...
                                            <a href="wishlist.jsp" data-toggle="tooltip" data-placement="left"
                                               title="Add to Wishlist"><i class="fa fa-heart-o"></i></a>
                                            <a href="compare.jsp" data-toggle="tooltip" data-placement="left"
                                    ...
                                    <div class="single-product-item text-center">
                                        ...
                                        <div class="product-details">
                                            <h2><a href="single-product.jsp">Bruno Compete Hoodie</a></h2>
                                            <div class="rating">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                    ...
                                    <div class="single-product-item text-center">
                                        ...
                                        <div class="product-details">
                                            <h2><a href="single-product.jsp">MH01-Black</a></h2>
                                            <div class="rating">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.jsp"><img src="assets/img/product-4.jpg"
                                                                                                                                     alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.jsp">Chaz Kangeroo Hoodie</a></h2>
                                            <div class="rating">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                        ...
                        <div class="tab-pane fade" id="new-products" role="tabpanel" aria-labelledby="new-products-tab">
                            <div class="products-wrapper">
                                <div class="products-carousel owl-carousel">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.jsp"><img src="assets/img/new-product-1.jpg"
                                                                                                                                     alt="Products" class="img-fluid"></a>
                                        </figure>
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.jsp"><img src="assets/img/new-product-2.jpg"
                                                                                                                                     alt="Products" class="img-fluid"></a>
                                        </figure>
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.jsp"><img src="assets/img/new-product-3.jpg"
                                                                                                                                     alt="Products" class="img-fluid"></a>
                                        </figure>
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.jsp"><img src="assets/img/new-product-4.jpg"
                                                                                                                                     alt="Products" class="img-fluid"></a>
                                        </figure>
                        ...
                        <div class="tab-pane fade" id="onsale" role="tabpanel" aria-labelledby="onsale-tab">
                            <div class="products-wrapper">
                                <div class="products-carousel owl-carousel">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.jsp"><img src="assets/img/sale-product-1.jpg"
                                                                                                                                     alt="Products" class="img-fluid"></a>
                                        </figure>
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.jsp"><img src="assets/img/sale-product-2.jpg"
                                                                                                                                     alt="Products" class="img-fluid"></a>
                                        </figure>
            ...
            <div class="col-lg-12">
                <div class="products-wrapper">
                    <div class="new-products-carousel owl-carousel">
                        ...
                        <div class="single-product-item text-center">
                            <figure class="product-thumb">
                                <a href="single-product.jsp"><img src="assets/img/new-product-1.jpg" alt="Products"
                                                                                                                         class="img-fluid"></a>
                            </figure>
                            ...
                            <div class="product-meta">
                                ...
                                <a href="compare.jsp" data-toggle="tooltip" data-placement="left" title="Compare"><i
                        ...
                        <div class="single-product-item text-center">
                            <figure class="product-thumb">
                                <a href="single-product.jsp"><img src="assets/img/new-product-2.jpg" alt="Products"
                                                                                                                         class="img-fluid"></a>
                            </figure>
                        ...
                        <div class="single-product-item text-center">
                            <figure class="product-thumb">
                                <a href="single-product.jsp"><img src="assets/img/new-product-3.jpg" alt="Products"
                                                                                                                         class="img-fluid"></a>
                            </figure>
                        ...
                        <div class="single-product-item text-center">
                            <figure class="product-thumb">
                                <a href="single-product.jsp"><img src="assets/img/new-product-4.jpg" alt="Products"
                                                                                                                         class="img-fluid"></a>
                            </figure>
                    ...
                    <div class="testimonial-content-wrap">
                        <div id="testimonialCarousel" class="owl-carousel">
                            ...
                            <div class="single-testimonial-item">
                                ...
                                <span class="client-email">Alex@email.here</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="blog-content-wrap">
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="single-blog-wrap">
                        <figure class="blog-thumb">
                            <a href="single-blog.jsp"><img src="assets/img/blog-thumb.jpg" alt="blog"
                                                                                                                  class="img-fluid"/></a>
                        ...
                        <div class="blog-details">
                            ...
                            <p>It is here you get the best.</p>
                            <a href="single-blog.jsp" class="btn-long-arrow">Read More</a>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <div class="single-blog-wrap">
                        <figure class="blog-thumb">
                            <a href="single-blog.jsp"><img src="assets/img/blog-thumb-2.jpg" alt="blog"
                                                                                                                  class="img-fluid"/></a>
                            <figcaption class="blog-icon">
                                <a href="single-blog.jsp"><i class="fa fa-file-image-o"></i></a>
                            </figcaption>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="single-blog-wrap">
                        <figure class="blog-thumb">
                            <a href="single-blog.jsp"><img src="assets/img/blog-thumb-3.jpg" alt="blog"
                                                                                                                  class="img-fluid"/></a>
                            <figcaption class="blog-icon">
                                <a href="single-blog.jsp"><i class="fa fa-file-image-o"></i></a>
                            </figcaption>
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <div class="follow-content-wrap">
                            <a href="index.jsp" class="logo"><img src="assets/img/logo.png" alt="logo"/></a>
                            <p>BEAUTIFUL CLOTHES, EARRINGS OF DIFFERENT COLOURS </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-6 mt-5 mt-md-0">
                            <div class="product-details">
                                ...
                                <p class="products-desc">Clothes Ideal for male, female, boys and girls of all ages.</p>
