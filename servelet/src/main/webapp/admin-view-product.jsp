                            ...
                            <div class="tab-content" id="myaccountContent">
                                ...
                                <div class="tab-pane fade show active" id="dashboad" role="tabpanel">
                                    <div class="myaccount-content">
                                        ...
                                        <div class="welcome">
                                            <p>Hello, ADMIN <strong>VIEW, EDIT/ DELETE PRODUCTS HERE</strong>
                                            </p>
                                     ...
                                     out2.println(      " <table class="+"table table-bordered"+">\n"+
                                            ...
                                            listOfProduct.forEach(product->{
                                               ...
                                               " <tr><td>"+
                                                ...
                                                out2.println("<a href ='product?edit="+product.getId()+"'> Edit</a>");
                                                out2.println("<a href ='product?delete="+product.getId()+"'> Delete</a>");
